...
export default function Home() {
    ...
    const [jokesData, jokesDataSet] = useState(data)
    ...
    return (
        <div className="container mx-auto p-2 [&_p]:py-2 [&_p]:px-4">
            ...
            <div className='flex justify-center gap-4 mt-4 [&>button]:px-4 [&>button]:py-2 [&>button]:rounded [&>button]:text-white [&>button]:transition-colors [&>button]:duration-300'>
                <button className='bg-blue-500 hover:bg-blue-600 focus-visible:bg-blue-600 focus-visible:outline-2 focus-visible:outline-blue-600 focus-visible:outline-offset-2' onClick={() => fetchJokes()}>Get Jokes</button>
                <button className='bg-red-500 hover:bg-red-600 focus-visible:bg-red-600 focus-visible:outline-2 focus-visible:outline-red-600 focus-visible:outline-offset-2' onClick={handleLogOut}>Logout</button>
            </div>
        </div>
    )
}